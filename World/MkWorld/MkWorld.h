...
class MkWorld : public AbstractWorld {
...
public:
	...
	MkWorld(shared_ptr<ParametersTable> _PT = nullptr);
	virtual ~MkWorld() = default;
	...
	virtual unordered_map<string, unordered_set<string>> requiredGroups() override {
		return { { groupNamePL->get(PT),{ "B:" + brainNamePL->get(PT) + ",23," + to_string(numberOfOutputsPL->get(PT)) } } };
