...
public void displayAgent(int x, int y, float task, int fx, int fy)
{
  /*
...
class Cell {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--stop-color=#cccccc", "Processing" };
    if (passedArgs != null) {
